...
class TestProject(unittest.TestCase):
    ...
    def test_load_rules(self):
        ...
        my_rule_good = FilesystemRule("/home/mahaloz/", 'filename', is_whitelist=True, is_dir=False)
        my_rule_bad = FilesystemRule("/etc/passwd", 'filename', is_whitelist=True, is_dir=False)
